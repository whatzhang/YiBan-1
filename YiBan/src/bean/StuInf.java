...
public class StuInf {
	...
	private String yb_schoolname="";//所在学校名称
	private String yb_collegename="";//所在学院名称
	private String yb_classname="";//所在班级名称
	private String yb_enteryear="";//入学年份
	private String yb_studentid="";//学号
	private String yb_examid="";//准考证号
	private String yb_admissionid="";//录取通知编号
	private String yb_employid="";//工号
	//real_me
	private String yb_sex="";//性别
	private String yb_birthday="";//生日
