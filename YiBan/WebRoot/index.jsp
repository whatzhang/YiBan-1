...
<body>
	<%
		...
		String pathh = request.getSession().getServletContext().getRealPath("")  + "\\template\\DownFile\\";
		List<String> filelist = wu.getDowenIfo(pathh);
		session.setAttribute("DownInf", filelist);
		...
		<div id="main-content" class="wrap-container zerogrid">
			...
			<div class="col-1-2 left">
				...
				<div class="art-content">
					...
					<p>其他下载</p>
					<%--<a href="${pageContext.request.contextPath}/html/contact.jsp"--%>
					<a href="${pageContext.request.contextPath}/html/ZXJ_collect4.jsp"
						class="more">我要下载</a>
				</div>
			</div>
			</article>
