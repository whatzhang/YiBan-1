					...
					<div class="art-content" id="art-content">
						<div id="contact_form">
							<form name="form1" id="ff" method="POST"
								...
								</label> <label> <span>家庭主要收入来源：</span> <input type="text"
								...
								<h3>第三部分：</h3>
								<p>国家励志奖学金申请表之申请人学习成绩及综合素质排名情况：</p>
								<div id="part3">
									<label> <span>必修课程门数：</span> <input type="number"
										placeholder="" name="CCNum" value="" required />
									</label> <label> <span>优秀课程门数：</span> <input type="number"
										placeholder="" name="GCNum" value="" required />
									</label> <label><span>良好课程门数：</span> <input type="number"
										placeholder="" name="OCNum" value="" required /> </label> <label>
										<span>中等课程门数：</span> <input type="number" placeholder=""
										name="MCNum" value="" required />
									</label> <label> <span>及格课程门数：</span> <input type="number"
										placeholder="" name="PCNum" value="" required />
									</label> <label> <span>同一专业年级学习成绩排名：</span> <input
										type="number" placeholder="" name="PCNum" value="" required />
									</label> <label> <span>及格课程门数：</span> <input type="number"
										placeholder="" name="PCNum" value="" required />
									</label> <span>同一专业年级学习成绩排名（名次/总人数）:</span> <span><input
										type="number" placeholder="" name="Perc" value="" required />名次/<input
										type="number" placeholder="" name="FulNum" value="" required />总人数</span>
								</div>

								<h3>第四部分：</h3>
								<p>国家励志奖学金申请表之申请人申请理由：</p>
