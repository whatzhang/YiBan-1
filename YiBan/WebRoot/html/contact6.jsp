						...
						<div id="contact_form">
							<form name="form1" id="ff" method="POST"
								...
								<label> <span>姓名:</span> <input type="text"
									...
									name="date" readonly="readonly" class="text" id="date" /> </select> <span>政治面貌:</span>
									...
									placeholder="专业" id="ProName" name="Profession" value=""
									required>
								...
								</select> </label> <label> <span>联系电话：</span> <input type="number"
								...
								<div id="part3">
									<label> <span>获奖日期:</span> <input type="text" placeholder="如2017.01.01"
										...
										placeholder="颁奖单位" id="Addr" name="Addr" value="" required />
									</label>
								</div>

								<input type="button" onclick="CreateMumber3()" value="+ 添加一个奖项">
