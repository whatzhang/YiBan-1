...
<body>
	...
	<div class="container" id="container">
		<form method="POST" name="form" action="./html/HandServlet?method=model1"
			...
			<div class="form-inline">
				...
				<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="rpr"
								placeholder="入学前户口所在地">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-xs-7 col-sm-7 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="facome"
								placeholder="家庭人均收入">
						</div>
					</div>
					<div class="col-xs-5 col-sm-5 col-md-4">
					...
					<div class="col-xs-7 col-sm-7 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="gftss"
								placeholder="高中毕业学校">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="radio">
							<label> <input type="radio" name="oad" value="是" checked>
								是
							</label>
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="radio">
							<label> <input type="radio" name="oad" value="否">
								否
							</label>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="radio">
							<label> <input type="radio" name="sinp" value="是" checked>
								是
							</label>
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="radio">
							<label> <input type="radio" name="sinp" value="否">
								否
							</label>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="radio">
							<label> <input type="radio" name="martyr" value="是"
								checked> 是
							</label>
						</div>
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="radio">
							<label> <input type="radio" name="martyr" value="否">
								否
							</label>
						</div>
					</div>
					...
					<div class="col-xs-6 col-sm-6 col-md-4">
						<div class="form-group">
							<input type="text" class="form-control" name="tel"
								placeholder="座机号（含区号" style="width: 99%">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-4">
						<div class="form-group">
							<input type="text" class="form-control" name="sphone"
								placeholder="手机号" style="width: 99%">
						</div>
					</div>
				</div>
				<div class="row" style="background-color: black; color: white">
