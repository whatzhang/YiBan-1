...
<body>
	...
	<div class="container" id="container">
		<form method="POST" name="form" action="./html/HandServlet?method=model2"
			...
			<div class="form-inline">
				...
				<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="postf"
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="idcardf"
								placeholder="请输入18位身份证号">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="phonef"
								placeholder="请输入手机号（不少于11位）" style="width: 99%">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="form-group">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="incomef"
								placeholder="输入家庭成员月均收入（如：1000元）">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="postm"
								placeholder="请输入6位邮政编码">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="phonem"
								placeholder="请输入手机号（不少于11位）" style="width: 99%">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="incomem"
								placeholder="输入家庭成员月均收入（如：1000元）">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-4">
				...
				<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="idcardo"
								placeholder="请输入18位身份证号">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="phoneo"
								placeholder="请输入手机号（不少于11位）" style="width: 99%">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="incomeo"
								placeholder="输入家庭成员月均收入（如：1000元）">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-4">
					...
					<div class="col-xs-6 col-sm-6 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="addresso"
								placeholder="精确到门牌号">
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="radio">
							<label> <input type="radio" name="diff" value="●特困 ◎一般困难"
								checked> 特困
							</label>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-2 col-sm-2 col-md-2">
						<div class="radio">
							<label> <input type="radio" name="think"
								value="●优秀  ◎良好  ◎一般  ◎差" checked> 优秀
							</label>
						</div>
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2">
				...
				<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="sfee"
								placeholder="年学费（如：4500元）">
						</div>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4">
						<div class="form-group">
					...
					<div class="col-xs-8 col-sm-8 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="lfee"
								placeholder="年最低生活费（如：1000元）">
						</div>
					</div>
				</div>
				<div id="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="form-group">
							<textarea class="form-control" name="reason" rows="5" cols="48"
								placeholder="家庭经济困难情况简要说明..."></textarea>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12">
